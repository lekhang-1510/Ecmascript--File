/**
 * 1. Lọc ra những nhân viên nào không có số điện thoại
 * 2. Lọc ra những nhân viên nào không có email
 * 3. Lọc ra những nhân viên không có cả sdt và email
 * 4. Biến đổi giá trị email của những nhân viên không có email thành: id_position@gmail.com
 * 5. Tính số tiền lương công ty phải trả trong 1 tháng
 */
const employees = [
  {
    id: 1,
